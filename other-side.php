...
<html>
<head>
<title>The Other Side of Me  | BookLand</title>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">The Other Side of Me</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
			...
			<div class="col-md-8 single-left">
				<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/17a.jpg">
								<div class="thumb-image"> <img src="images/17a.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/17b.jpg">
								 <div class="thumb-image"> <img src="images/17b.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
						</ul>
					</div>
					<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					<h3>The Other Side of Me</h3>
					<h4><span class="item_price">&#8377 201</span></h4>
					<div class="rating1">
			...
			<div class="new-collections-grids">
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".5s">
						<div class="new-collections-grid1-image">
							<a href="wings.php" class="product-image"><img src="images/13a.jpg" alt=" " class="img-responsive"></a>
							<div class="new-collections-grid1-image-pos">
								<a href="wings.php">Quick View</a>
							</div>
						...
						<h4><a href="wings.php">Wings On Fire</a></h4>
						<p>by APJ Abdul Kalam</p>
						<div class="new-collections-grid1-left simpleCart_shelfItem">
							<p><i>&#8377 350</i> <span class="item_price">&#8377 188</span></p>
						</div>
					</div>
				</div>
				<div class="col-md-6 new-collections-grid">
					<div class="new-collections-grid1-sub">
						<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".6s">
							<div class="new-collections-grid1-image">
								<a href="motorcycle-diaries.php" class="product-image"><img src="images/14a.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos">
									<a href="motorcycle-diaries.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right">
									<div class="rating">
										<div class="rating-left">
							...
							<h4><a href="motorcycle-diaries.php">The Motorcycle Diaries</a></h4>
							<p>2 men who embark on a road journey </p>
							<div class="new-collections-grid1-left simpleCart_shelfItem">
								<p><i>&#8377 350</i> <span class="item_price">&#8377 235</span></p>
							</div>
						</div>
					</div>
					<div class="new-collections-grid1-sub">
						<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".7s">
							<div class="new-collections-grid1-image">
								<a href="steve-jobs.php" class="product-image"><img src="images/15a.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos">
									<a href="steve-jobs.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right">
									<div class="rating">
										<div class="rating-left">
							...
							<h4><a href="steve-jobs.php">Steve Jobs</a></h4>
							<p>A man who literally transformed the digital lifestyle</p>
							<div class="new-collections-grid1-left simpleCart_shelfItem">
								<p><i>&#8377 550</i> <span class="item_price">&#8377 278</span></p>
							</div>
						</div>
					</div>
					<div class="clearfix"> </div>
				...
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".8s">
						<div class="new-collections-grid1-image">
							<a href="infinity.php" class="product-image"><img src="images/16a.jpg" alt=" " class="img-responsive"></a>
							<div class="new-collections-grid1-image-pos">
								<a href="infinity.php">Quick View</a>
							</div>
							<div class="new-collections-grid1-right">
								<div class="rating">
									<div class="rating-left">
						...
						<h4><a href="infinity.php">Travelling to Infinity</a></h4>
						<p>My Life with Stephen</p>
						<div class="new-collections-grid1-left simpleCart_shelfItem">
							<p><i>&#8377 399</i> <span class="item_price">&#8377 299</span></p>
						</div>
					</div>
				</div>
