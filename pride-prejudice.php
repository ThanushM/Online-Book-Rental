...
<html>
<head>
<title>Pride and Prejudice | BookLand</title>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Pride and Prejudice</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
			...
			<div class="col-md-8 single-left">
				<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/6a.jpg">
								<div class="thumb-image"> <img src="images/6a.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/6b.jpg">
								 <div class="thumb-image"> <img src="images/6b.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
						</ul>
					</div>
					<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					...
					<h4><span class="item_price">&#8377 199</span></h4>
					<div class="rating1">
			...
			<div class="new-collections-grids">
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".5s">
						<div class="new-collections-grid1-image">
							<a href="fifty.php" class="product-image"><img src="images/7a.jpg" alt=" " class="img-responsive"></a>
						...
						<h4><a href="the-hyperion.php">Fifty Shades of Grey</a></h4>
						<p>The book that is known for its daring</p>
						<div class="new-collections-grid1-left simpleCart_shelfItem">
							<p><i>&#8377 499</i> <span class="item_price">&#8377 160</span></p>
						</div>
					</div>
				</div>
				<div class="col-md-6 new-collections-grid">
					<div class="new-collections-grid1-sub">
						<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".6s">
							<div class="new-collections-grid1-image">
								<a href="the-forever-war.php" class="product-image"><img src="images/9a.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos">
							...
							<h4><a href="the-forever-war.php">A Walk to Remember</a></h4>
					...
					<div class="new-collections-grid1-sub">
						<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".7s">
							...
							<h4><a href="the-martian.php">The Notebook</a></h4>
				...
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".8s">
						<div class="new-collections-grid1-image">
							<a href="enders-game.php" class="product-image"><img src="images/10a.jpg" alt=" " class="img-responsive"></a>
							<div class="new-collections-grid1-image-pos">
								<a href="fault.php">Quick View</a>
							</div>
							<div class="new-collections-grid1-right">
								<div class="rating">
									<div class="rating-left">
						...
						<h4><a href="enders-game.php">The Fault in our Stars</a></h4>
