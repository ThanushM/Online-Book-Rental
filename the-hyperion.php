...
<html>
<head>
<title>The Time Machine | BookLand</title>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">The Hyperion</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
			...
			<div class="col-md-8 single-left">
				<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/2a.jpg">
								<div class="thumb-image"> <img src="images/2a.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/2b.jpg">
								 <div class="thumb-image"> <img src="images/2b.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
						</ul>
					</div>
					<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					<h3>The Hyperion</h3>
					<h4><span class="item_price">&#8377 300</span></h4>
					<div class="rating1">
					...
					<div class="description">
						...
						<p>A stunning tour de force filled with transcendent awe and wonder, Hyperion is a masterwork of science fiction that resonates with excitement and invention, the first volume in a remarkable epic by the multiple-award-winning author of The Hollow Man.</p>
					</div>
					...
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						...
						<div id="myTabContent" class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active bootstrap-tab-text" id="home" aria-labelledby="home-tab">
								...
								<p>On the world called Hyperion, beyond the reach of galactic law, waits a creature called the Shrike. There are those who worship it. There are those who fear it. And there are those who have vowed to destroy it. In the Valley of the Time Tombs, where huge, brooding structures move backward through time, the Shrike waits for them all.
									<span>On the eve of Armageddon, with the entire galaxy at war, seven pilgrims set forth on a final voyage to Hyperion seeking the answers to the unsolved riddles of their lives. Each carries a desperate hope—and a terrible secret. And one may hold the fate of humanity in his hands.</span></p>
							</div>
			...
			<div class="new-collections-grids">
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".5s">
						<div class="new-collections-grid1-image">
							<a href="the-time-machine.php" class="product-image"><img src="images/1a.jpg" alt=" " class="img-responsive"></a>
							<div class="new-collections-grid1-image-pos">
								<a href="the-time-machine.php">Quick View</a>
							</div>
						...
						<h4><a href="the-time-machine.php">The Time Machine</a></h4>
						<p>Travel through Your Time</p>
						<div class="new-collections-grid1-left simpleCart_shelfItem">
							<p><i>&#8377 125</i> <span class="item_price">&#837 781</span><a class="item_add" href="#">add to cart </a></p>
						</div>
					</div>
				</div>
				<div class="col-md-6 new-collections-grid">
					<div class="new-collections-grid1-sub">
						<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".6s">
							<div class="new-collections-grid1-image">
								<a href="the-forever-war.php" class="product-image"><img src="images/3a.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos">
									<a href="the-forever-war.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right">
									<div class="rating">
										<div class="rating-left">
							...
							<h4><a href="the-forever-war.php">The Forever War</a></h4>
							<p>On the Verge of a War</p>
							<div class="new-collections-grid1-left simpleCart_shelfItem">
								<p><i> &#8377 1132</i> <span class="item_price"> &#8377 730</span><a class="item_add" href="#">add to cart </a></p>
							</div>
						</div>
					</div>
					<div class="new-collections-grid1-sub">
						<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".7s">
							<div class="new-collections-grid1-image">
								<a href="the-martian.php" class="product-image"><img src="images/4a.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos">
									<a href="the-martian.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right">
									<div class="rating">
										<div class="rating-left">
							...
							<h4><a href="the-martian.php">The Martian</a></h4>
							<p>I’m stranded on Mars.</p>
							<div class="new-collections-grid1-left simpleCart_shelfItem">
								<p><i> &#8377 399</i> <span class="item_price"> &#8377 299</span><a class="item_add" href="#">add to cart </a></p>
							</div>
						</div>
					</div>
					<div class="clearfix"> </div>
				...
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".8s">
						<div class="new-collections-grid1-image">
							<a href="enders-game.php" class="product-image"><img src="images/5b.jpg" alt=" " class="img-responsive"></a>
							<div class="new-collections-grid1-image-pos">
						...
						<div class="new-collections-grid1-left simpleCart_shelfItem">
							<p><i> &#8377 499</i> <span class="item_price"> &#8377 450</span><a class="item_add" href="#">add to cart </a></p>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
