...
<html>
<head>
<title>A Walk to Remember | BookLand</title>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">A Walk to Remember</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
			...
			<div class="col-md-8 single-left">
				<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/9a.jpg">
								<div class="thumb-image"> <img src="images/9a.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/9b.jpg">
								 <div class="thumb-image"> <img src="images/9b.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
						</ul>
					</div>
					<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					...
					<h4><span class="item_price">&#8377 203</span></h4>
					<div class="rating1">
			...
			<div class="new-collections-grids">
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".5s">
						...
						<h4><a href="fifty.php">Fifty Shades of Grey</a></h4>
				...
				<div class="col-md-6 new-collections-grid">
					<div class="new-collections-grid1-sub">
						<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".6s">
							<div class="new-collections-grid1-image">
								<a href="love-story.php" class="product-image"><img src="images/11a.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos">
					...
					<div class="new-collections-grid1-sub">
						<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".7s">
							<div class="new-collections-grid1-image">
								<a href="raven.php" class="product-image"><img src="images/12a.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos">
									<a href="raven.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right">
									<div class="rating">
										<div class="rating-left">
							...
							<h4><a href="raven.php">The Raven Prince</a></h4>
							<p>A prince in the dawn...</p>
							<div class="new-collections-grid1-left simpleCart_shelfItem">
								<p><i>&#8377 360</i> <span class="item_price">&#8377 258</span></p>
							</div>
						</div>
					</div>
					<div class="clearfix"> </div>
