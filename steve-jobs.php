...
<html>
<head>
<title>Steve Jobs  | BookLand</title>
			...
			<div class="col-md-8 single-left">
				<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/15a.jpg">
								<div class="thumb-image"> <img src="images/15a.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/15b.jpg">
								 <div class="thumb-image"> <img src="images/15b.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
						</ul>
					</div>
					<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					<h3>Steve Jobs</h3>
					<h4><span class="item_price">&#8377 278</span></h4>
					<div class="rating1">
					...
					<div class="color-quality">
						<div class="color-quality-left">
							...
							<ul>
								...
								<li><span></span>Hardcover</a></li><br>
