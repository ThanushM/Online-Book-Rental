...
<html>
<head>
<title>Wings of Fire  | BookLand</title>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Wings of Fire</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
			...
			<div class="col-md-8 single-left">
				<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/13a.jpg">
								<div class="thumb-image"> <img src="images/13a.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/13b.jpg">
								 <div class="thumb-image"> <img src="images/13b.jpg" data-imagezoom="true" class="img-responsive"> </div>
							</li>
						</ul>
					</div>
					<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					<h3>Wings of Fire: An Autobiography 1st Edition</h3>
					<h4><span class="item_price">&#8377 188</span></h4>
					<div class="rating1">
			...
			<div class="new-collections-grids">
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".5s">
						...
						<h4><a href="motorcycle-diaries.php">The Mototrcycle Diaries</a></h4>
				...
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".8s">
						<div class="new-collections-grid1-image">
							<a href="other-side.php" class="product-image"><img src="images/17a.jpg" alt=" " class="img-responsive"></a>
							<div class="new-collections-grid1-image-pos">
						...
						<p>Sidney attended eleven different schools</p>
						<div class="new-collections-grid1-left simpleCart_shelfItem">
							<p><i>&#8377 350</i> <span class="item_price">&#8377 201</span></p>
						</div>
					</div>
				</div>
